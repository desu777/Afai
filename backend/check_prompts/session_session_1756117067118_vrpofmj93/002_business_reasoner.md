...
**LLM Response Time:** 11670.89ms  
**Session:** session_1756117067118_vrpofmj93  
**Timestamp:** 2025-08-25 12:18:02  
...
- **Analyze Context:** Before any other action, you must analyze the `What is the best product to lower nitrate levels?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `What is the best product to lower nitrate levels?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
