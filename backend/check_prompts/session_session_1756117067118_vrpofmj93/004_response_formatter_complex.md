...
**LLM Response Time:** 27454.86ms  
**Session:** session_1756117067118_vrpofmj93  
**Timestamp:** 2025-08-25 12:18:34  
**User Query:** What is the best product to lower nitrate levels?  
...
<PRODUCT_CARD>
  <NAME>Zeo Mix</NAME>
  <TITLE>Zeo Mix – Zeolite Filter Media for ULNS and Heavy-Stocked Marine Aquariums</TITLE>
  <CATEGORY>zeolite_media</CATEGORY>
  <DOMAIN>seawater</DOMAIN>
  <DIFFICULTY>advanced</DIFFICULTY>
  <DOSAGE>100ml_per_100L per as_directed (reactor or mesh bag), replace every 6 weeks, continuous</DOSAGE>
  <COMPATIBLE_WITH>AF Media Reactor Series</COMPATIBLE_WITH>
  <SIZES>1000ml, 5000ml</SIZES>
  <FULL_CONTENT>Aquaforest Zeo Mix is a specialized blend of selected zeolites designed for demanding marine aquariums, including those with plentiful livestock and Ultra Low Nutrient Systems (ULNS). Its unique composition provides a comprehensive, multifunctional filtration media that powerfully absorbs ammonia and ammonium ions at the initial stage, inhibiting nitrate formation. Zeo Mix also binds phenols and heavy metals, ensuring crystal-clear water and healthier livestock. Recommended for advanced aquarists, Zeo Mix is best used in systems with regular nutrient monitoring and supplementation. Dosage: 100 ml per 100 l of aquarium water. Rinse thoroughly in RODI water before use. Suitable for use in media reactors (recommended flow 300–500 l/h) or filter mesh bags/socks. Replace media every 6 weeks. Zeo Mix does not lower potassium levels. Due to its high adsorption capability, improper use can cause nutrient stripping—monitor with regular ICP-OES tests. Keep away from children; aquarium use only.</FULL_CONTENT>
  <URL_EN>https://aquaforest.eu/en/products/seawater/water-treatment/zeo-mix/</URL_EN>
  <URL_PL>https://aquaforest.eu/pl/produkty/seawater/parametry-wody/zeo-mix/</URL_PL>
</PRODUCT_CARD>
...
<PRODUCT_CARD>
  ...
  <TITLE>AF Purifying Resin – Selective Ion Exchange Resin for Nitrate Removal in Freshwater Aquariums</TITLE>
  <CATEGORY>resins</CATEGORY>
  <DOMAIN>freshwater</DOMAIN>
  <DIFFICULTY>beginner</DIFFICULTY>
  <DOSAGE>125ml per 400L, continuous until exhausted, any time</DOSAGE>
  <COMPATIBLE_WITH>None specified</COMPATIBLE_WITH>
  <SIZES>125ml, 250ml</SIZES>
  <FULL_CONTENT>AF Purifying Resin is a specialist ion exchange resin designed for use in freshwater aquariums, dedicated especially to heavily stocked tanks struggling with elevated nitrates (NO3-). Its selective formula chemically absorbs nitrogen compounds without affecting essential minerals needed by fish and plants. AF Purifying Resin clarifies the water, removes harmful compounds, supports algae control, and reduces the frequency of water changes by maintaining low nitrate levels. The product can be used both preventively and as a solution to acute nitrate spikes. **How to use:** 125 ml treats up to 400 liters of water. Place the resin in a fine-mesh filter bag (included), then position it in a filter basket with constant water flow—always after mechanical and biological filter media for best performance and longevity. When the resin turns dark brown, it's time to replace or regenerate it. Regeneration: soak in 50% chlorine-based bleach solution for 6 hours, rinse thoroughly, and soak in clean water for 24 hours before reuse. **Features:** does not affect hardness or essential minerals, safe for all aquarium inhabitants, and reusable multiple times with proper regeneration. **Pro tips:** For optimal efficiency, always place ion exchange resins and absorbers after other filter media. Product available in 125 ml and 250 ml sizes.</FULL_CONTENT>
  <URL_EN>https://aquaforest.eu/en/products/freshwater/watertreatment/af-purifying-resin/</URL_EN>
  <URL_PL>https://aquaforest.eu/pl/produkty/freshwater/utrzymanie-parametrow-wody/af-purifying-resin/</URL_PL>
</PRODUCT_CARD>
...
USER QUESTION: "What is the best product to lower nitrate levels?"
LANGUAGE: en
...
This is your first and most critical step. Before any other analysis, you MUST assess the user's expertise level based on their query (`What is the best product to lower nitrate levels?`). This assessment will fundamentally shape the tone, complexity, and scope of your entire response.
