...
**LLM Response Time:** 9426.25ms  
**Session:** session_1756123448370_q1xboxbk2  
**Timestamp:** 2025-08-25 14:04:19  
**User Query:** potrzebuje karmy z klipsem jakie macie?  
...
potrzebuje karmy z klipsem jakie macie?
...
- **Analyze Context:** Before any other action, you must analyze the `potrzebuje karmy z klipsem jakie macie?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `potrzebuje karmy z klipsem jakie macie?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
