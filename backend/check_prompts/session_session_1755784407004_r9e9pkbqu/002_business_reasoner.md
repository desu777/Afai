...
**LLM Response Time:** 18043.67ms  
**Session:** session_1755784407004_r9e9pkbqu  
**Timestamp:** 2025-08-21 15:53:48  
...
- **Analyze Context:** Before any other action, you must analyze the `I want to build a new tank, how should I use Pro Bio S in the early stages?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `I want to build a new tank, how should I use Pro Bio S in the early stages?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
