...
**LLM Response Time:** 8015.77ms  
**Session:** session_1756107490566_nh0tf4onc  
**Timestamp:** 2025-08-25 09:38:20  
...
- **Analyze Context:** Before any other action, you must analyze the `파이토믹스도 sps 키우는데 도움이 많이 돼는편이야?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `파이토믹스도 sps 키우는데 도움이 많이 돼는편이야?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
