...
**LLM Response Time:** 13043.31ms  
**Session:** session_1755861593998_v6tvawmm3  
**Timestamp:** 2025-08-22 13:20:08  
...
- **Analyze Context:** Before any other action, you must analyze the `What's the difference between Component 1+2+3+ and Components Pro?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `What's the difference between Component 1+2+3+ and Components Pro?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
