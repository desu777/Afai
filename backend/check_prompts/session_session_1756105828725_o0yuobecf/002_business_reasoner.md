...
**LLM Response Time:** 18413.38ms  
**Session:** session_1756105828725_o0yuobecf  
**Timestamp:** 2025-08-25 09:10:49  
...
I want anemones tank with many hybrid nemos
...
- **Analyze Context:** Before any other action, you must analyze the `I want anemones tank with many hybrid nemos` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `I want anemones tank with many hybrid nemos` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
