...
**LLM Response Time:** 14557.09ms  
**Session:** session_1756106186654_w2qedzdq9  
**Timestamp:** 2025-08-25 09:16:42  
...
- **Analyze Context:** Before any other action, you must analyze the `makroglony jak o nie dbac ?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `makroglony jak o nie dbac ?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
