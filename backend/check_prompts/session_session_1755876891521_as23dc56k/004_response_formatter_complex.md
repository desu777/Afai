...
**LLM Response Time:** 35203.50ms  
**Session:** session_1755876891521_as23dc56k  
**Timestamp:** 2025-08-22 17:35:53  
...
<PRODUCT_CARD>
  ...
  <TITLE>AF Filter Floss – Dense Mechanical Filtration Floss for Aquariums</TITLE>
  <CATEGORY>filtration_media</CATEGORY>
  <DOMAIN>seawater</DOMAIN>
  <DIFFICULTY>beginner</DIFFICULTY>
  <DOSAGE>cut_to_fit per as_needed, replace when dirty, none</DOSAGE>
  <COMPATIBLE_WITH>n, o, n, e</COMPATIBLE_WITH>
  <SIZES>20x100cm</SIZES>
  <FULL_CONTENT>AF Filter Floss is a dense, compact mechanical filtration floss designed for effective removal of visible water contaminants in aquariums. The non-woven fabric efficiently traps large and small particles such as detritus, uneaten food, and fish waste, preventing dust and maintaining crystal clear water. This universal media can be cut to fit any filtration system including sumps, canisters, internal and hang-on-back filters. By capturing debris, AF Filter Floss helps control nitrate, ammonia, and phosphate levels, reducing risk of algae outbreaks and improving tank health. Safe for fish, corals, plants, and invertebrates; contains no chemicals and does not affect water parameters. Dimensions: 20 x 100 cm sheet, easy to cut and replace. Replace regularly when soiled for best results.</FULL_CONTENT>
  <URL_EN>https://aquaforest.eu/en/products/seawater/aquarium-equipment/af-filter-floss/</URL_EN>
  <URL_PL>https://aquaforest.eu/pl/produkty/seawater/wyposazenie-akwarium/af-filter-floss/</URL_PL>
</PRODUCT_CARD>
...
<PRODUCT_CARD>
  ...
  <TITLE>Bypass AF275 AF435 – Flow Bypass for OceanGuard Aquarium Filtration</TITLE>
  <CATEGORY>aquarium_accessories</CATEGORY>
  <DOMAIN>seawater</DOMAIN>
  <DIFFICULTY>beginner</DIFFICULTY>
  <DOSAGE>install_as_needed per none, as needed, maintenance time</DOSAGE>
  <COMPATIBLE_WITH>AF OceanGuard 275 Aquarium, AF OceanGuard 435 Aquarium</COMPATIBLE_WITH>
  <SIZES>Not specified</SIZES>
  <FULL_CONTENT>Bypass AF275 AF435 is a dedicated accessory for Aquaforest OceanGuard 275 and 435 aquariums. This bypass enables the installation of an additional fluidization (fluidized bed) filter in your aquarium’s filtration system. By splitting the main water flow, the bypass allows you to connect a secondary filter chamber, optimizing overall filtration efficiency and expanding the aquarium’s filtration capabilities. A fluidization filter, also known as a fluidized bed filter, is a device where the filter media (such as sand, biopellets, or special granules) are kept in motion by an upward flow of water. This dynamic movement increases the contact area between water and media, providing highly efficient biological or chemical filtration, accelerating removal of organic waste, ammonia, nitrate, or phosphate, and helping to stabilize water parameters. The Bypass AF275 AF435 is made of durable, aquarium-safe materials and is designed for easy installation and maintenance. The accessory is essential for advanced aquarists looking to enhance water clarity, nutrient export, and overall aquarium health by upgrading their OceanGuard system with extra filtration. Compatible only with Aquaforest OceanGuard 275 Aquarium and OceanGuard 435 Aquarium. For aquarium use only.</FULL_CONTENT>
  <URL_EN>https://aquaforest.eu/en/products/seawater/aquarium-equipment/bypassaf275af435/</URL_EN>
  <URL_PL>https://aquaforest.eu/pl/produkty/seawater/wyposazenie-akwarium/bypass-af275-af435/</URL_PL>
</PRODUCT_CARD>
...
<PRODUCT_CARD>
  ...
  <TITLE>AF Filter Sock XL – Large Mechanical Filtration Sock for Aquariums</TITLE>
  <CATEGORY>filtration_media</CATEGORY>
  <DOMAIN>seawater</DOMAIN>
  <DIFFICULTY>beginner</DIFFICULTY>
  <DOSAGE>install_on_drain_pipe per as_needed, rinse regularly, none</DOSAGE>
  <COMPATIBLE_WITH>n, o, n, e</COMPATIBLE_WITH>
  <SIZES>XL</SIZES>
  <FULL_CONTENT>AF Filter Sock XL is a large mechanical filtration sock designed to efficiently remove all types of suspended particles, dust, detritus, and food residues from aquarium water. Its 200 μm medium-density material captures both fine and coarse contaminants, ensuring clean, clear water and supporting biological balance. Safe for marine environments, the sock is made from non-reactive materials and can be used in both small and large sump systems. Ideal as a prefilter, it protects refugium, bioceramics, and live rock from debris and prevents air bubbles from reaching display tanks. Easy to install on drain pipes or with a standard 4-inch bracket (not included). Dimensions: length 31.5 cm, outer diameter 18.3 cm, inner diameter 16.3 cm. Routine rinsing during maintenance keeps the sock efficient and extends its life. Suitable for use as a mechanical filter or as a bag for absorbers or activated carbon.</FULL_CONTENT>
  <URL_EN>https://aquaforest.eu/en/products/seawater/aquarium-equipment/af-filter-sock-xl/</URL_EN>
  <URL_PL>https://aquaforest.eu/pl/produkty/seawater/wyposazenie-akwarium/af-filter-sock-xl/</URL_PL>
</PRODUCT_CARD>
