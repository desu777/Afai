...
**LLM Response Time:** 11523.10ms  
**Session:** session_1756116692340_baex1tte2  
**Timestamp:** 2025-08-25 12:11:48  
...
- **Analyze Context:** Before any other action, you must analyze the `What's the best salt for a new mixed reef aquarium?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `What's the best salt for a new mixed reef aquarium?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
