...
**LLM Response Time:** 9205.93ms  
**Session:** session_1756116692340_baex1tte2  
**Timestamp:** 2025-08-25 12:15:40  
...
- **Analyze Context:** Before any other action, you must analyze the `My tank has high NO3 and PO4, should I use AF NitraPhos Minus or Pro Bio S?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `My tank has high NO3 and PO4, should I use AF NitraPhos Minus or Pro Bio S?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
