...
**LLM Response Time:** 10597.40ms  
**Session:** session_1755863036541_zehs68ql1  
**Timestamp:** 2025-08-22 13:44:08  
...
- **Analyze Context:** Before any other action, you must analyze the `How to balance N:P ratio in ULNS system?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `How to balance N:P ratio in ULNS system?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
