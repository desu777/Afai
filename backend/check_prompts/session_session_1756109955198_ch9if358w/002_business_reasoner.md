...
**LLM Response Time:** 9841.20ms  
**Session:** session_1756109955198_ch9if358w  
**Timestamp:** 2025-08-25 10:19:27  
...
- **Analyze Context:** Before any other action, you must analyze the `jakie macie karmy dla ryb?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `jakie macie karmy dla ryb?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
