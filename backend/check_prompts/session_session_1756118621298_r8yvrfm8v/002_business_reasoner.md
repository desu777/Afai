...
**LLM Response Time:** 11389.84ms  
**Session:** session_1756118621298_r8yvrfm8v  
**Timestamp:** 2025-08-25 12:43:57  
...
Prowadzę dojrzały, 2-letni zbiornik SPS o pojemności 550 litrów, oparty w całości na Waszym systemie probiotycznym. Od około 3 miesięcy borykam się z trudnym do zdiagnozowania problemem, który dotyka głównie wrażliwe akropory (np. Acropora tenuis, A. millepora).
...
- **Analyze Context:** Before any other action, you must analyze the `Prowadzę dojrzały, 2-letni zbiornik SPS o pojemności 550 litrów, oparty w całości na Waszym systemie probiotycznym. Od około 3 miesięcy borykam się z trudnym do zdiagnozowania problemem, który dotyka głównie wrażliwe akropory (np. Acropora tenuis, A. millepora).
...
` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `Prowadzę dojrzały, 2-letni zbiornik SPS o pojemności 550 litrów, oparty w całości na Waszym systemie probiotycznym. Od około 3 miesięcy borykam się z trudnym do zdiagnozowania problemem, który dotyka głównie wrażliwe akropory (np. Acropora tenuis, A. millepora).
...
` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
