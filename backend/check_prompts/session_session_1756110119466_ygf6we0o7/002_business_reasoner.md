...
**LLM Response Time:** 7528.62ms  
**Session:** session_1756110119466_ygf6we0o7  
**Timestamp:** 2025-08-25 10:22:11  
...
- **Analyze Context:** Before any other action, you must analyze the `What products do I need for cycling a new reef tank?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `What products do I need for cycling a new reef tank?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
