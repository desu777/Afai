...
**LLM Response Time:** 17147.23ms  
**Session:** session_1755860542643_yu13zz50x  
**Timestamp:** 2025-08-22 13:02:41  
...
- **Analyze Context:** Before any other action, you must analyze the `opowiedz mi o component 123 ` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `opowiedz mi o component 123 ` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
