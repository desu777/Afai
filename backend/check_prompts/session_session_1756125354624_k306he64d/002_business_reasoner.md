...
**LLM Response Time:** 14464.85ms  
**Session:** session_1756125354624_k306he64d  
**Timestamp:** 2025-08-25 14:36:10  
...
- **Analyze Context:** Before any other action, you must analyze the `My SPS corals are pale, which supplements should I use?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `My SPS corals are pale, which supplements should I use?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
