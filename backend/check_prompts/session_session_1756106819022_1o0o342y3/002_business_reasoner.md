...
**LLM Response Time:** 15070.80ms  
**Session:** session_1756106819022_1o0o342y3  
**Timestamp:** 2025-08-25 09:27:17  
...
How long does it take for white spot to kill a fish
...
- **Analyze Context:** Before any other action, you must analyze the `How long does it take for white spot to kill a fish` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `How long does it take for white spot to kill a fish` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
