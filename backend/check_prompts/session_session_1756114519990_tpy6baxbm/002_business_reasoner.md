...
**LLM Response Time:** 12563.67ms  
**Session:** session_1756114519990_tpy6baxbm  
**Timestamp:** 2025-08-25 11:35:37  
...
- **Analyze Context:** Before any other action, you must analyze the `How to set up the Balling Method for a new SPS tank?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `How to set up the Balling Method for a new SPS tank?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
