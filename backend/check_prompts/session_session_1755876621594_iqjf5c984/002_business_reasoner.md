...
**LLM Response Time:** 18260.35ms  
**Session:** session_1755876621594_iqjf5c984  
**Timestamp:** 2025-08-22 17:30:41  
...
Cześć, walczę ostatnio z cyjanobakteriami na piasku. Akwarium ma 5 miesięcy, parametry w normie, NO3 i PO4 są bardzo niskie, prawie niewykrywalne testami. Używam soli probiotycznej, ale problem nie znika. Jak mogę się tego pozbyć i co może być przyczyną przy tak niskich nutrientach?
...
- **Analyze Context:** Before any other action, you must analyze the `Cześć, walczę ostatnio z cyjanobakteriami na piasku. Akwarium ma 5 miesięcy, parametry w normie, NO3 i PO4 są bardzo niskie, prawie niewykrywalne testami. Używam soli probiotycznej, ale problem nie znika. Jak mogę się tego pozbyć i co może być przyczyną przy tak niskich nutrientach?` and `No previous conversation context` to infer the user's aquarium system type.
...
- Meticulously scan the `Cześć, walczę ostatnio z cyjanobakteriami na piasku. Akwarium ma 5 miesięcy, parametry w normie, NO3 i PO4 są bardzo niskie, prawie niewykrywalne testami. Używam soli probiotycznej, ale problem nie znika. Jak mogę się tego pozbyć i co może być przyczyną przy tak niskich nutrientach?` for any mentioned Aquaforest products (e.g., "component 123", "bio pro s").
