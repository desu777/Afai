...
const DetailModal: React.FC<DetailModalProps> = ({ item, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl border border-brand-200/50 max-w-4xl w-full max-h-[85vh] sm:max-h-[90vh] overflow-hidden flex flex-col mx-2 sm:mx-4">
        {/* Header */}
        <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-brand-200/30 flex items-center justify-between">
          <div>
            <h3 className="text-base sm:text-lg font-medium text-gray-900">Query Details</h3>
