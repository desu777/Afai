  ...
  return (
    <div className="flex justify-start mb-4 sm:mb-6">
      <div className="flex items-start space-x-2 sm:space-x-4 max-w-[90%] sm:max-w-3xl w-full">
        ...
        <div className="hidden sm:flex w-10 h-10 rounded-2xl bg-gradient-to-br from-brand-600 via-brand-700 to-brand-800 items-center justify-center shadow-brand flex-shrink-0 animate-float">
          <div className="circle">
            <div className="wave"></div>
          </div>
        </div>
        
        <div className="rounded-2xl sm:rounded-3xl px-4 py-3 sm:px-6 sm:py-4 bg-white/95 backdrop-blur-md border border-brand-200/40 shadow-sm hover:shadow-lg transition-all duration-300 flex-1 min-w-0">
